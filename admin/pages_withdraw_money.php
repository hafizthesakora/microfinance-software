...
if (isset($_POST['withdrawal'])) {
    ...
    error_log("Withdrawal request received with the following details:");
    ...
    try {
        ...
        if ($transaction_amt > $amt) {
            ...
            $acc_amount = $amt - $transaction_amt;
            ...
            $stmt->bind_param('sisssssississsss', $tr_code, $account_id, $acc_name, $account_number, $acc_type, $tr_type, $tr_status, $client_id, $client_name, $client_national_id, $transaction_amt, $client_phone, $acc_amount, $receiving_acc_no, $receiving_acc_name, $receiving_acc_holder);
            if ($stmt->execute()) {
